...
\ccsdesc[100]{Software and its engineering~Distributed systems organizing principles}
\ccsdesc[300]{Information systems~Distributed database transactions}
\ccsdesc[100]{Information systems~Distributed storage}
\ccsdesc[500]{Security and privacy~Distributed systems security}
\ccsdesc[300]{Security and privacy~Information flow control}



\keywords{taint tracking, information flow control, endorsement, byzantine failures, cross-domain, serializabililty, trust, atomic transaction, blockchain} %TODO mandatory; please add comma-separated list of keywords
...
This is used in controller DAG reduction~(\cref{sec:reducing}).
...
We might imagine a UTXO-style currency application~\cite{utxo} which tracks only input resources of the same currency as dependencies: anything which was necessary to authorize a ``spend'' isn't considered part of the history of the currency resource.
